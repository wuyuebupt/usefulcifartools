...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        logits = FullyConnected('linear', l, out_dim=self.c, nl=tf.identity)
...
def get_data(train_or_test):
    ...
    ds = dataset.CifarCustom(train_or_test, NUM_CLASS)
...
def get_config():
    ...
    return TrainConfig(
        ...
        model=Model(n=NUM_UNITS,c=NUM_CLASS),
        max_epoch=70,
        # max_epoch=400,
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--num_class', help='how many parts to use', type=int, default=100)
